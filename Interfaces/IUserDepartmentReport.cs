...
namespace TaskManagement.API.Interfaces
{
    public interface IUserDepartmentReport
    {
        ...
        Task<IEnumerable<Task_DetailsOutPutNT_List>> GetTaskDetailsNTAsync(Task_UserDepartmentDownloadDetailsInputNT task_DetailsInputNT);
        ...
        Task<IEnumerable<Task_DetailsOutPutNT_List>> GetTaskDetailsNTAsync_NT(Task_UserDepartmentDetailsInputNT task_DetailsInputNT);
    }
}
