...
namespace TaskManagement.API.Controllers
{
    ...
    [ApiController]
    public class TaskManagement_ReportsController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly ITaskManagement_Reports _repository;
        public static IWebHostEnvironment _environment;
        private readonly FileSettings _fileSettings;

        public IDapperDbConnection _dapperDbConnection;
        public TaskManagement_ReportsController(ITaskManagement_Reports repository, IConfiguration configuration, IWebHostEnvironment environment, IOptions<FileSettings> fileSettings)
        {
        ...
        [HttpPost("Task-Management_Report/Task-Dashboard-Filter")]
        [Authorize]
        ...
        [HttpPost("Task-Management_Report/Task-Dashboard_NT")]
        [Authorize]
